/* tslint:disable */
/* eslint-disable */
export function start_vane_web3(relay_node_multi_addr: string, account: string, network: string, live: boolean): Promise<PublicInterfaceWorkerJs>;
...
export interface InitOutput {
  ...
  readonly closure1553_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure1951_externref_shim: (a: number, b: number, c: any, d: any) => void;
