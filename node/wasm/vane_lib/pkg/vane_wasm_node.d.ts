...
export interface InitOutput {
  ...
  readonly closure1243_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1599_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure1997_externref_shim: (a: number, b: number, c: any, d: any) => void;
