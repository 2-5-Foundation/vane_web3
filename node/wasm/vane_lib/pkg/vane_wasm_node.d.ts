...
export interface InitOutput {
  ...
  readonly closure1236_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1592_externref_shim: (a: number, b: number, c: any) => void;
  ...
  readonly closure1990_externref_shim: (a: number, b: number, c: any, d: any) => void;
