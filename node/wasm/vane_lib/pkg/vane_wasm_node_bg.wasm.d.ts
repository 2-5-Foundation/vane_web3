...
export const publicinterfaceworkerjs_initiateTransaction: (a: number, b: number, c: number, d: number, e: number, f: number, g: any, h: number, i: number, j: any, k: any) => any;
...
export const closure1960_externref_shim: (a: number, b: number, c: any, d: any) => void;
